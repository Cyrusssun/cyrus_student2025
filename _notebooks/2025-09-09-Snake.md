...
<style>
    ...
    canvas {
        ...
        border-style: solid;
        border-width: 19px;
        border-color: #c83d9cff;
        background-color: #40cde0ff; /* Darker version of #88bc4c */
    }
...
<div class="container">
    ...
    <div class="container bg-secondary" style="text-align:center;">
        ...
        <div id="menu" class="py-4 text-light">
            <p>Welcome to Snake, press <span style="background-color: #40cde0ff; color: #000000">Space</span> to begin</p>
            <a id="new_game" class="link-alert">new game</a>
            <a id="setting_menu" class="link-alert">settings</a>
        </div>
        <!-- Game Over -->
        <div id="gameover" class="py-4 text-light">
            <p>Game Over, press <span style="background-color: #40cde0ff; color: #000000">space</span> to try again</p>
        ...
        <div id="setting" class="py-4 text-light">
            <p>Settings Screen, press <span style="background-color: #40cde0ff; color: #000000">space</span> to go back to playing</p>
